    ...
    <>
      ...
      <main className="qualify-page">
        <div className="qualify-container">
          {/* Logo */}
          <a href="/" className="qualify-logo-link">
            <img src="/logo/logo.svg" alt="Sendiee" className="qualify-logo" />
          </a>
              ...
              <>
                ...
                >
                  ...
                  <div className="form-row">
                    ...
                    <div className="form-group">
                      <label htmlFor="q-businessName">Business Name</label>
                      <input
                        id="q-businessName"
                        type="text"
                  ...
                  <div className="form-group">
                    <label htmlFor="q-website">Website / Profile Link</label>
                    <input
                      id="q-website"
                      type="url"
